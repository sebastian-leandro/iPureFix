  ...
  return (
    <section className="w-full h-auto overflow-hidden">
      <div className="w-full h-full px-8">
        <div className="w-full h-auto md:h-[360px] rounded-md bg-tertiary px-6 py-2">
          <div className="w-full h-full md:flex-row flex-col flex items-center justify-between md:py-0 py-12 px-12">
            <div className="w-full flex flex-col items-start justify-center gap-y-4 text-center">
